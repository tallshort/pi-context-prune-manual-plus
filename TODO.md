...
- [x] Report summarizer usage through Pi usage entries and the pi-stats sidecar while preserving exactly-once `/pruner stats` accounting (manually verified by the user).
